...
$block-width: 220px;
$bar-slide-margin-top: 20px;
.bar-slide-box {
  height: $block-width+$bar-slide-margin-top*4;
  overflow: hidden;
}
.bar-slide-list {
  display: flex;
  ...
  .bar-slide-item {
    ...
    align-items: center;
    margin: $bar-slide-margin-top 40px;
    width: $block-width;
    .img {
      width: $block-width;
      height: $block-width;
